      ...
      <div className="main">
        ...
        <div className="content" id="content">
          ...
          <div className="content__list">
            ...
            <div className="content__card  content__card--2" ref={card2Ref}>
              <div className="content__bg">
              </div>
              <h3 className='content__txt'>Enjoy the scenery on the road</h3>
            </div>
            <div className="content__card content__card--3" ref={card3Ref}>
              <div className="content__bg">
              </div>
              <h3 className='content__txt'>Enjoy the scenery on the road</h3>
            </div>
            <div className="content__card content__card--4" ref={card4Ref}>
              <div className="content__bg">
              </div>
              <h3 className='content__txt'>Enjoy the scenery on the road</h3>
            </div>
